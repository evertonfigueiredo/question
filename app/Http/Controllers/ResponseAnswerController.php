...
public function index(Request $request)
{
    ...
    // Pegamos os unique_id distintos paginados
    $uniqueIds = ResponseAnswer::where('survey_id', $surveyId)
        ->select('unique_id') // Pegamos apenas o unique_id
        ->distinct()
        ->paginate(100); // Defina o número de registros por página
