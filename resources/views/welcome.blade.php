...
<head>
    ...
    <title>Question! Sua plataforma de pesquisas.</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.1.2/dist/tailwind.min.css" rel="stylesheet">
    <style>
        .gradient-bg {
            background: linear-gradient(135deg, #e8ba2f 0%, #c95933 100%);
        }
    </style>
</head>
<body class="font-sans antialiased">
    ...
    <!-- Hero Section -->
    <section class="gradient-bg text-white text-center py-24">
        <div class="container mx-auto px-4">
            <h2 class="text-5xl font-extrabold mb-4">Bem-vindo ao Question!</h2>
            <p class="text-xl mb-6">Uma plataforma inovadora para realizar pesquisas e coleta de dados.</p>
            <a href="#about" class="bg-green-600 hover:bg-green-700 text-white py-3 px-8 rounded-lg text-xl">Saiba Mais</a>
        </div>
    </section>
    ...
    <section id="about" class="py-20 bg-gray-100">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl font-semibold text-gray-800 mb-4">O Que é Question?</h2>
            <p class="text-lg text-gray-600 mb-6">Nosso sistema permite criar e responder pesquisas de forma fácil, rápida e eficaz. Com ele, você pode acompanhar e analisar os resultados em tempo real!</p>
            <p class="text-lg text-gray-600 mb-6">Você pode criar pesquisas personalizadas, coletar dados e visualizar os resultados em gráficos interativos.</p>
            <a href="{{ route('surveys.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white py-3 px-8 rounded-lg text-xl">Iniciar Agora</a>
        </div>
    </section>

    <!-- Footer Section -->
    <footer class="bg-gray-800 text-white text-center py-6">
        <p>&copy; 2025 Question. Todos os direitos reservados.</p>
    </footer>
