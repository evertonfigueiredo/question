                    ...
                    @elseif($question->type === 'multiple')
                        ...
                        <div>
                            @foreach($question->options as $option)
                                <div>
                                    <input type="radio" required name="answer" id="option_{{ $option->id }}" value="{{ $option->option_text }}" class="mr-2" />
